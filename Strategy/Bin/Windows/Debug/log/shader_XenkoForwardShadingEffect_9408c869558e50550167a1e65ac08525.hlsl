...
//
#line 833 "C:\Users\Tom\Documents\Xenko Projects\Strategy\Strategy\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_9408c869558e50550167a1e65ac08525.hlsl"
...
@G    Pixel => 27ffe52dc77d712f1bd7a0ad5b1a249f
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 862 "C:\Users\Tom\Documents\Xenko Projects\Strategy\Strategy\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_9408c869558e50550167a1e65ac08525.hlsl"
...
#line 282
  ...
  dp4 r13.z, r4.xyzw, cb1[r7.w + 30].xyzw  // r13.z <- shadowPosition.z
  ...
  add r4.z, r4.z, -cb1[44].x  // r4.z <- depthVS

#line 218
  mad r4.xy, r4.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r11.yw, r4.xxxy  // r11.y <- base_uv.x; r11.w <- base_uv.y
  add r4.xy, r4.xyxx, -r11.ywyy  // r4.x <- s; r4.y <- t
  add r11.yw, r11.yyyw, l(0.000000, -0.500000, 0.000000, -0.500000)
  mul r11.yw, r11.yyyw, cb1[27].zzzw
...
#line 231
  ...
  mul r4.x, r13.x, r13.y
  mad r16.xyzw, r15.xwzw, cb1[27].zwzw, r11.ywyw

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r16.xyxx, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id102 return value>

#line 240
  mul r16.xy, r13.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r16.zwzz, t4.xxxx, s1, r4.z  // r7.w <- <SampleTextureAndCompare_id102 return value>
...
#line 243
  ...
  mov r14.zw, r15.wwwy
  mad r17.xyzw, r14.xzxw, cb1[27].zwzw, r11.ywyw

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.xyxx, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id102 return value>

#line 239
  mad r4.x, r13.x, r4.y, r4.x
  mad r18.xyzw, r15.xyzy, cb1[27].zwzw, r11.ywyw

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r18.xyxx, t4.xxxx, s1, r4.z

#line 240
  mad r4.x, r16.y, r4.y, r4.x

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r18.zwzz, t4.xxxx, s1, r4.z
...
#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z

#line 242
  mad r4.x, r14.z, r4.y, r4.x
  mov r15.y, r14.y
  mad r15.xyzw, r15.xyzy, cb1[27].zwzw, r11.ywyw

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r15.xyxx, t4.xxxx, s1, r4.z

#line 243
  mad r4.x, r13.y, r4.y, r4.x

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r15.zwzz, t4.xxxx, s1, r4.z

#line 244
  mad r4.x, r14.w, r4.y, r4.x
  mul r4.y, r13.w, r13.z
  mad r11.yw, r14.xxxy, cb1[27].zzzw, r11.yyyw

#line 198
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r11.ywyy, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id102 return value>
...
#line 533
  mul r4.xyz, r4.xxxx, cb1[26].xyzx
...
float ComputeShadowFromCascade_id101(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id98(shadowPosition.xy, depthVS);
}
