...
//
#line 421 "C:\Users\Tom\Documents\Xenko Projects\Strategy\Strategy\Bin\Windows\Debug\log\shader_FXAAShaderEffect_c065bab7bd1b50ecc3976a3936f33d7f.hlsl"
...
@G    Pixel => 6d73531d3955a0b075c75d44303e4700
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 57 "C:\Users\Tom\Documents\Xenko Projects\Strategy\Strategy\Bin\Windows\Debug\log\shader_FXAAShaderEffect_c065bab7bd1b50ecc3976a3936f33d7f.hlsl"
...
#line 162
    ...
    add r4.y, -r2.x, r4.x  // r4.y <- posN.x
    movc r4.x, r3.z, r4.x, r4.y  // r4.x <- posN.x
    add r4.y, -r2.w, r4.z  // r4.y <- posN.y
...
#line 173
    ...
    add r4.w, r2.x, r5.x  // r4.w <- posP.x
    movc r5.x, r3.w, r5.x, r4.w  // r5.x <- posP.x
    add r4.w, r2.w, r5.z  // r4.w <- posP.y
...
#line 231
          ge r3.zw, |r3.xxxy|, r1.zzzz  // r3.z <- doneN
          mad r4.y, -r2.x, l(1.500000), r4.x  // r4.y <- posN.x
          movc r4.x, r3.z, r4.x, r4.y  // r4.x <- posN.x
          mad r4.y, -r2.w, l(1.500000), r4.z  // r4.y <- posN.y
          movc r4.z, r3.z, r4.z, r4.y  // r4.z <- posN.y
          not r4.yw, r3.zzzw
          or r4.y, r4.w, r4.y  // r4.y <- doneNP
          mad r4.w, r2.x, l(1.500000), r5.x  // r4.w <- posP.x
          movc r5.x, r3.w, r5.x, r4.w  // r5.x <- posP.x
          mad r4.w, r2.w, l(1.500000), r5.z  // r4.w <- posP.y
          movc r5.z, r3.w, r5.z, r4.w  // r5.z <- posP.y
          if_nz r4.y
